...
import { FaUserEdit, FaChartLine, FaHandshake } from 'react-icons/fa';
    ...
    <div style={styles.appContainer}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.contentContainer}>
          <h2 style={styles.contentTitle}>Your Path to Funding in 3 Simple Steps</h2>
          ...
          <div style={styles.stepsContainer}>
            ...
            <div style={styles.stepCard}>
              ...
              <h3 style={styles.stepTitle}>Get BIG Score</h3>
              <ul style={styles.stepDetails}>
                <li>Compliance analysis</li>
                <li>Growth potential evaluation</li>
                <li>Pitch quality assessment</li>
              </ul>
            </div>
            ...
            <div style={styles.stepCard}>
              ...
              <ul style={styles.stepDetails}>
                <li>Matched investors/grants</li>
                <li>Connect with advisors</li>
                <li>Apply to accelerators</li>
              </ul>
            </div>
          </div>
