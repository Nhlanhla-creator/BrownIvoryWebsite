...
import { ChevronDown, ChevronUp, Edit, Printer, ExternalLink, FileText, Check } from "lucide-react"
import { useNavigate } from "react-router-dom"
import styles from "../InvestorDashboard/legitimacy.module.css"
import "./investor-profile-summary.css"

function LegitimacyScoreCard({ profileData }) {
...
const InvestorProfileSummary = ({ data, onEdit }) => {
  ...
  return (
    <div className="investor-profile-summary">
      ...
      <div className="mb-6">
        <LegitimacyScoreCard profileData={data} />
      </div>
